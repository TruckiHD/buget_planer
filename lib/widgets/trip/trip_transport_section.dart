      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 10),
            ...
            Row(children: [
              Flexible(child: Text(RouteService.getTransportLabel(t.mode, widget.trip), style: TextStyle(fontSize: 11, color: t.mode.color, fontWeight: FontWeight.w600), overflow: TextOverflow.ellipsis)),
              if (t.durationMinutes != null) ...[
                Text(' · ', style: TextStyle(fontSize: 11, color: mutedColor)),
                Flexible(child: Text(RouteService.formatDuration(t.durationMinutes!), style: TextStyle(fontSize: 11, color: mutedColor), overflow: TextOverflow.ellipsis)),
              ],
              if (isAutoGenerated) ...[
