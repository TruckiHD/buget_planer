...
class _TripDetailScreenState extends State<TripDetailScreen> {
  ...
  Future<void> _copyTrip() async {
    ...
    final copied = TripPlan(
      ...
      travelPassType: _trip.travelPassType,
      travelPassCents: _trip.travelPassCents,
      travelPassDays: _trip.travelPassDays,
      outboundTransportMode: _trip.outboundTransportMode,
      outboundTransportCents: _trip.outboundTransportCents,
      outboundDate: _trip.outboundDate != null ? newStart.add(_trip.outboundDate!.difference(_trip.startsOn)) : null,
      returnTransportMode: _trip.returnTransportMode,
      returnTransportCents: _trip.returnTransportCents,
      returnDate: _trip.returnDate != null ? newStart.add(_trip.returnDate!.difference(_trip.startsOn)) : null,
      rentalCarCompany: _trip.rentalCarCompany,
      rentalCarStartDate: _trip.rentalCarStartDate != null ? newStart.add(_trip.rentalCarStartDate!.difference(_trip.startsOn)) : null,
      rentalCarEndDate: _trip.rentalCarEndDate != null ? newStart.add(_trip.rentalCarEndDate!.difference(_trip.startsOn)) : null,
      rentalCarCostCents: _trip.rentalCarCostCents,
      rentalCarFuelCents: _trip.rentalCarFuelCents,
      rentalCarTollCents: _trip.rentalCarTollCents,
      rentalCarParkingCents: _trip.rentalCarParkingCents,
      segments: _trip.segments.map((s) => TripSegment(
        ...
        isBaseLocation: s.isBaseLocation,
        baseTransportCostCents: s.baseTransportCostCents,
      )).toList(),
